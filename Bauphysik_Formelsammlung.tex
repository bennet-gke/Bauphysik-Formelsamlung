...
\newtcolorbox{formelbox}[1]{
    ...
    segmentation style={solid, draw=black!15, line width=0.4pt},
    before skip=10pt,
    after skip=10pt,
    unbreakable
}
...
\begin{formelbox}{Materialkennwerte}
    \begin{align*}
        \rho_{Wasser} &= 1000 \eh{kg/m^3} = 1{,}00 \eh{g/cm^3} \\
        \rho_{Luft} &= 1{,}204 \eh{kg/m^3} = 0{,}001204 \eh{g/cm^3} \\
        c_{Wasser} &= 4{,}182 \eh{kJ/(kg K)} = 4182 \eh{J/(kg K)} \\
        c_{Aluminium} &= 0{,}900 \eh{kJ/(kg K)} = 900 \eh{J/(kg K)} \\
        c_{Kupfer} &= 0{,}385 \eh{kJ/(kg K)} = 385 \eh{J/(kg K)} \\
        c_{Stahl} &= 0{,}470 \eh{kJ/(kg K)} = 470 \eh{J/(kg K)}
    \end{align*}
    \tcblower
    \begin{symbols}
...
\begin{formelbox}{Zeiteinheiten und Umrechnungen}
    \begin{align*}
        1 \text{ Minute (min)} &= 60 \eh{s} \\
        1 \text{ Stunde (h)} &= 60 \text{ min} = 3.600 \eh{s} \\
        1 \text{ Tag (d)} &= 24 \text{ h} = 1.440 \text{ min} = 86.400 \eh{s} \\
        1 \text{ Jahr (a, 365 Tage)} &= 365 \text{ d} = 8.760 \text{ h} = 525.600 \text{ min} = 31.536.000 \eh{s} \\
        1 \text{ Schaltjahr (366 Tage)} &= 366 \text{ d} = 8.784 \text{ h} = 527.040 \text{ min} = 31.622.400 \eh{s}
    \end{align*}
    \tcblower
    \begin{symbols}
