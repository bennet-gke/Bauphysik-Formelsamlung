...
\begin{formelbox}{Wärmedurchgang (Nebeneinanderliegende Flächen)}
    ...
    \tcblower
    \begin{symbols}
U_j& \eh{W/(m^2 K)} & Einzelne Wärmedurchgangskoeffizienten \\
A_j& \eh{m^2} & Einzelne Flächen
    \end{symbols}
\end{formelbox}
...
\begin{formelbox}{Wärmedurchgang (Reihenschaltung)}
    ...
    \begin{symbols}
         ...
         \Lambda_i& \eh{W/(m^2 K)} & Wärmedurchlasskoeffizient der Einzelschicht \\
         \Lambda_j& \eh{W/(m^2 K)} & Wärmedurchlasskoeffizient von Teilflächen \\
         A_j& \eh{m^2} & Fläche der Teilfläche
    \end{symbols}
\end{formelbox}
